...
export const Card = ({
  ...
  return (<>
      ...
      {open && (
        <div className="fixed inset-0 h-screen z-50 overflow-auto">
          ...
          <motion.div
            ...
            className="max-w-5xl mx-auto bg-red-600 h-fit  z-[60] my-10 p-4 md:p-10 rounded-3xl font-sans relative">
            <button
    ...
    <motion.button
      layoutId={layout ? `card-${card.title}` : undefined}
      onClick={handleOpen}
      className="rounded-3xl bg-black h-80 w-56 md:h-[35rem] md:w-96 overflow-hidden flex flex-col items-start justify-start relative z-10 transition-all duration-300 shadow-md hover:shadow-2xl hover:-translate-y-2"
    >
